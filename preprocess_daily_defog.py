...
config = {
    "dir": r"D:\Research_Datasets\KaggleFOG_Data\data\unlabeled",
    "save_path": r"./",
    "sample": True,
}
dir = config["dir"]
...
# %%
if config["sample"]:
    torch.save(train_tensor, f"{config['save_path']}/daily_living_sample_defog.pt")
else:
    torch.save(train_tensor, f"{config['save_path']}/daily_living_defog.pt")
# %%
