...
# %%
config = {
    "pretrain_data": r"C:\Users\timot\OneDrive\Desktop\EMORY\Spring 2024\BMI-534\project-code\code\TFC-pretraining\datasets\HAR\train.pt",
    "subset": False,
    "batch_size": 128,
...
for epoch in range(1, configs.num_epoch + 1):
    ...
    if train_loss < gtrain_loss:
        ...
        torch.save(
            ...
            os.path.join(experiment_log_dir, "saved_models", f"har_ckp_last.pt"),
        )
